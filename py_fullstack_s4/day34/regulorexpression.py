...
#
# print(re.findall("(?:ad)+yuan","adadyuangfsdui")) #?:取消分组的特性
# print(re.findall("(?:\d)+yuan","adad678423yuang4234fsdui"))#显示包括分组之外的匹配内容

#命名分组(?P<"名字">\x)
ret7=re.findall(r"\w+\.aticles\.\d{4}","yuan.aticles.1234")
print(ret7)
ret8=re.search(r"(?P<author>\w+)\\aticles\\(?P<id>\d{4})",r"yuan\aticles\1234")
print(ret8.group("author"))
